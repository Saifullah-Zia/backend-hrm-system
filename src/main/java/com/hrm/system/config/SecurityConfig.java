    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/payroll-otp/**").hasAnyRole("ADMIN", "SUPERADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/users/me").hasAnyRole("EMPLOYEE", "ADMIN", "SUPERADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/employee-profiles/avatars/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/employee-profiles/**").hasAnyRole("ADMIN", "SUPERADMIN", "EMPLOYEE")
                        .requestMatchers(HttpMethod.POST, "/api/employee-profiles/me/avatar").hasAnyRole("EMPLOYEE", "ADMIN", "SUPERADMIN")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/payroll/*/approve", "/api/payroll/*/pay", "/api/payroll/*/regenerate", "/api/payroll/bulk-approve", "/api/payroll/bulk-pay").hasAnyRole("ADMIN", "SUPERADMIN")
                        ...
                        .requestMatchers("/api/audit-logs/**").hasAnyRole("ADMIN", "SUPERADMIN")
